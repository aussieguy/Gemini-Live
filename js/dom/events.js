...
// Don't want to display the settings dialog
...
export function setupEventListeners(agent) {
    ...
    async function microphone() {
        try {
            ...
            // Change microphone button image as it is clicked
            if (elements.micBtn.classList.contains('active')) {
                elements.micBtn.style.backgroundImage = "url('./images/microphone-active.png')";
            }
            else {
                elements.micBtn.style.backgroundImage = "url('./images/microphone-muted.png')";
            }
...
//                elements.cameraBtn.classList.add('active');
                elements.cameraBtn.style.backgroundImage = "url('./images/webcam-active.png')";

            } else {
                await agent.stopCameraCapture();
//                elements.cameraBtn.classList.remove('active');
                elements.cameraBtn.style.backgroundImage = "url('./images/webcam-muted.png')";
            }
